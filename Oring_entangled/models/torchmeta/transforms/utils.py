...
from omni.isaac.orbit_envs.soft.Oring_entangled.models.torchmeta.utils.data.task import Task

def apply_wrapper(wrapper, task_or_dataset=None):
    if task_or_dataset is None:
        return wrapper

    from omni.isaac.orbit_envs.soft.Oring_entangled.models.torchmeta.utils.data import MetaDataset
